...
SAXON="java ${JAVA_OPTIONS} -cp .:${EXIST_HOME}/lib/*:${EXIST_HOME}/lib/endorsed/* net.sf.saxon.Transform  env=${EXIST_ENV} context_path=${EXIST_CONTEXT_PATH} default_app_path=${EXIST_DEFAULT_APP_PATH} -xsl:${EXIST_HOME}/adjust-conf-files.xsl -catalog:${EXIST_HOME}/catalog.xml"
